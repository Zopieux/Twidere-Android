...
object ParcelableUserUtils {
    ...
    @JvmOverloads fun fromUser(user: User, accountKey: UserKey?, position: Long = 0): ParcelableUser {
        ...
        obj.key = UserKeyUtils.fromUser(user, accountKey?.host)
    ...
    fun updateExtraInformation(user: ParcelableUser, account: ParcelableAccount, manager: UserColorNameManager) {
